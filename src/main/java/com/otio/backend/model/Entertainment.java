...
public class Entertainment extends Activity {
    ...
    public Entertainment(String id, String name, String subcategory, String imageName, double rating, String imagePath, String mapsLink) {
        this.id = id;
        this.name = name;
    ...
    public Entertainment(String id, String name, String subcategory, String imageName, double rating, String imagePath,
    ...
    public String toString() {
        return "Entertainment [id=" + id + ", name=" + name + ", subcategory=" + subcategory + ", imageName="
                + imageName + ", rating=" + rating + ", imagePath=" + imagePath + ", mapsLink=" + mapsLink
                + ", timeSlots=" + timeSlots + "]";
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Entertainment) {
            return (this.getId().equals(((Entertainment)obj).getId()));
        }
        return false;
    }
