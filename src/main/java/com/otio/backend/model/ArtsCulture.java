...
public class ArtsCulture extends Activity {
    
    public ArtsCulture() {}

    public ArtsCulture(String id, String name, String subcategory, String imageName, double rating, String imagePath,
            String mapsLink) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "ArtsCulture [id=" + id + ", name=" + name + ", subcategory=" + subcategory + ", imageName=" + imageName
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ArtsCulture) {
            return (this.getId().equals(((ArtsCulture)obj).getId()));
        }
        return false;
    }
}
