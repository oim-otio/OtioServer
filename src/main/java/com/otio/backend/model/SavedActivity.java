...
public class SavedActivity extends Activity {
    ...
    public SavedActivity(String id, String name, String subcategory, String imageName, double rating, String imagePath,
            String mapsLink) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "SavedActivity [id=" + id + ", name=" + name + ", subcategory=" + subcategory + ", imageName=" + imageName
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SavedActivity) {
            return (this.getId().equals(((SavedActivity)obj).getId()));
        }
        return false;
    }
}
