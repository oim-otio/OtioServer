...
public class Nightlife extends Activity {
    ...
    public Nightlife(String id, String name, String subcategory, String imageName, double rating, String imagePath,
            String mapsLink) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "Nightlife [id=" + id + ", name=" + name + ", subcategory=" + subcategory + ", imageName=" + imageName
                + ", rating=" + rating + ", imagePath=" + imagePath + ", mapsLink=" + mapsLink + "]";
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Nightlife) {
            return (this.getId().equals(((Nightlife)obj).getId()));
        }
        return false;
    }
}
