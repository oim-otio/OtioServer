...
public class Wellness extends Activity {
    ...
    public Wellness(String id, String name, String subcategory, String imageName, double rating, String imagePath,
            String mapsLink) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "Wellness [id=" + id + ", name=" + name + ", subcategory=" + subcategory + ", imageName=" + imageName
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Wellness) {
            return (this.getId().equals(((Wellness)obj).getId()));
        }
        return false;
    }
